...
urlpatterns = [
    ...
    path('student/',views.staff,name='staff'),
    path('student-student/',views.staff_staff,name='staff-staff'),
    ...
    path('view-student/<str:staff>/',views.staff_profile_view,name='view-profile'),
    path('view-attendance/<str:staff>/',views.view_attendance_staff,name='view-attendance'),
    path('update-student/<str:staff>/',views.staff_profile_update,name='profile-update-admin'),
    path('delete-student/<str:staff>/',views.staff_profile_delete,name='delete-profile'),
    ...
    path('attendance-student-date/',views.attendance_staff_date,name='attendance-staff-date'),
